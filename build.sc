...
object tjug extends UntemplateModule {
  ...
  override def untemplateIndexNameFullyQualified : Option[String] = Some("tjug.IndexedUntemplates")
  ...
  override def untemplateSelectCustomizer: untemplate.Customizer.Selector = { key =>
    ...
    // with out = out.copy=...
    //
    // e.g. out = out.copy(extraImports=Seq("tjug.*"))
